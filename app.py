...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "1234567899923hufrr823bkerj83bue8e"
    jwt = JWTManager(app)
    ...
    def missing_token_callback(error):
        return (jsonify({"message": "Request does not contain access token.", "error": "authorization_required"}), 401)
